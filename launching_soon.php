<?php include 'includes/header_launching_soon.html'; ?>
        <div class="launching_soon_container">
            <div class="launching_soon_content">
                <img src="images/logo_launching.png">
                ...
                <form class="subscribe_email_form">
                    <h3>Enter your Email ID below to get notified about our launch &amp; subscribe to WTF blogs.</h3>
                    <div class="form-group clearfix">
                        <input type="email" class="form-control form-inline" placeholder="Email Address">
                        <button class="btn-primary" type="submit">Subscribe</button>
                    </div>
                </form>
                <img class="short_logo" src="images/short_logo.png">
            </div>
        </div>
